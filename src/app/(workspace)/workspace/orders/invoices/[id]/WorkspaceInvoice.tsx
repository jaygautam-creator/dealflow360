...
export function WorkspaceInvoice({
  ...
  invoice: {
    ...
    orderNumber: string; quotationNumber: string; repName: string; repEmail: string;
      ...
      <Card className="print:border-none print:shadow-none">
        ...
        <CardContent className="space-y-6">
          <div className="hidden print:block">
            <p className="text-lg font-semibold">DealFlow360</p>
          ...
          <div className="flex flex-wrap justify-between gap-6 text-sm">
            <div>
              ...
              <p className="text-neutral-500">{invoice.customer.email}</p>
